...
def get_args(is_train=True):
    ...
    parser.add_argument('--transformer', default=choices[0], help='Which vit transformer model', choices=choices)
    parser.add_argument('--transformation', type=str, default=None, help='Transformation stage. None|TPS')
    parser.add_argument('--num_fiducial', type=int, default=20, help='number of fiduciary points of TPS-STN')
