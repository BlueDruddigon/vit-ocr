...
__all__ = [
  'VisionTransformer',
  'Deit_ViT_T_16_Weights',
  'Deit_ViT_S_16_Weights',
  'Deit_ViT_B_16_Weights',
  'vit_t_16',
  'vit_s_16',
  'vit_b_16',
]
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, seqlen: int = 25):
...
class Deit_ViT_T_16_Weights(WeightsEnum):
    DEFAULT = Weights(
...
class Deit_ViT_S_16_Weights(WeightsEnum):
    DEFAULT = Weights(
...
class Deit_ViT_B_16_Weights(WeightsEnum):
    DEFAULT = Weights(
...
def vit_t_16(
  *, weights: Optional[Deit_ViT_T_16_Weights] = None, progress: bool = True, **kwargs: Any
) -> VisionTransformer:
    weights = Deit_ViT_T_16_Weights.verify(weights)
...
def vit_s_16(
  *, weights: Optional[Deit_ViT_S_16_Weights] = None, progress: bool = True, **kwargs: Any
) -> VisionTransformer:
    weights = Deit_ViT_S_16_Weights.verify(weights)
...
def vit_b_16(
  *, weights: Optional[Deit_ViT_B_16_Weights] = None, progress: bool = True, **kwargs: Any
) -> VisionTransformer:
    weights = Deit_ViT_B_16_Weights.verify(weights)
  ...
  reset_heads: bool = False,
    ...
    if new_seq_length != seq_length:
        ...
        if seq_length_1d * seq_length_1d != seq_length:
            raise ValueError(
              f'seq_length is not a perfect square! Instead got seq_length_1d * seq_length_1d = '
              f'{seq_length_1d * seq_length_1d } and seq_length = {seq_length}'
            )
