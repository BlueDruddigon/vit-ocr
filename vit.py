...
class MLPBlock(MLP):
    ...
    def _load_from_state_dict(
        ...
        if version is None or version < 2:
            ...
            for i in range(2):
                for m_type in ['weight', 'bias']:
                    old_key = f'{prefix}linear_{i + 1}.{m_type}'
                    new_key = f'{prefix}{3 * i}.{m_type}'
...
def create_vit(model_name: str, *args, **kwargs) -> VisionTransformer:
...
def interpolate_embeddings(
    ...
    Args:
        ...
        interpolation_mode (str): The algorithm used for up-sampling.
            Default: bicubic.
        reset_heads (bool): If true, not copying the state of heads.
            Default: False.
